function Phi = phiSenzaAttritoStatico(q,dq,ddq)
%
% SIX - Gennaio 2005
%
% Phi = phi(q,dq,ddq)
...
% 
% Ingressi:
%   q,dq,ddq : vettori 6x1 secondo convenzioni COMAU (gradi link)
%
% Uscite:
%   Phi : regressore ridotto in numerico
%
% Note:
%   le coppie in uscita sono in convenzione COMAU e sono quelle richieste agli attuatori (a valle dei riduttori)
%
% File letti:
